...
below you can also see two self similarity matrixes of the same track as before, one for timbre and one for chroma. for me the chroma chart looks especially interesting because of the two distinct lines ytou see running through the graph.
